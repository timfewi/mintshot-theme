...
MintShot Themes is an open-source collection of dark VS Code themes with mint-accented UI colors, soft contrast, and bright syntax highlighting designed for long coding sessions.
